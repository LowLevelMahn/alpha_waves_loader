...
ptr16		struc ;	(sizeof=0x4)	; XREF:	seg000:executeable_bufferr
...
TANDY_string	db 'TANDY'              ; DATA XREF: seg000:gfx_string_offset_tableo
		db 5 dup(1)		; 0
HERCULES_string	db  48h	; H		; DATA XREF: seg000:gfx_string_offset_tableo
		db  45h	; E
		db  52h	; R
		db  43h	; C
		db  55h	; U
...
gfx_type_array	db 2, 3, 40h, 80h, 5	; 0
					; DATA XREF: START_GAME_IS_GFX_SUPPORTED_sub_12+Er
gfx_type_array2	db 2, 3, 2, 1, 5	; 0
					; DATA XREF: START_GAME_IS_GFX_SUPPORTED_sub_12+2Cr
...
grafic_type_supported_table db 5 dup(0)	; DATA XREF: GFX_SELECT_MENU_sub_9+18o
					...
					;
					; ---------------------------
word_752	dw 2 dup(0)		; DATA XREF: START_GAME_IS_GFX_SUPPORTED_sub_12+1r
...
main_menu_screen:			; CODE XREF: start_0+2B4j start_0+2CAj ...
		cld
		cli
		mov	ax, cs
		mov	ss, ax
...
shutdown_cleanup:			; CODE XREF: start_0+25j start_0+82j
					; DATA XREF: ...
		xor	ah, ah
...
start_game:				; CODE XREF: start_0+82j
		...
		add	bx, offset config_tat_buffer ; block_@
...
; __int16 __usercall START_GAME_sub_11<ax>(gfx_block_t *block_@<bx>)
...
;
;
; just checks if prog1.cc exists
;
; --------------------
